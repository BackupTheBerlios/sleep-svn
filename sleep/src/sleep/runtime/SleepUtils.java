...
public class SleepUtils
{
   ...
   {
      return ((value.objectValue() != null && value.objectValue().getClass() == SleepClosure.CLOSURE_CLASS) || value.toString().charAt(0) == '&');
   }
   ...
   {
     if (value.objectValue() != null && value.objectValue().getClass() == SleepClosure.CLOSURE_CLASS)
