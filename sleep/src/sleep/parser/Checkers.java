/* 
 ...
 .-----------------------.
 | sleep.parser.Checkers |____________________________________________________
 |                                                                            |
   Author: Raphael Mudge (rsmudge@mtu.edu)
           http://www.csl.mtu.edu/~rsmudge/
 
   Description: Checker functions for deciding if the parameters form a 
     specific construct or not.

   Documentation: To see the entire concrete syntax of the SLEEP language
     handled by this parser view the file docs/bnf.txt.

   Changes:
   11/14/02 - some basic house cleaning and refactoring -- rsm
